...
<%--
  ...
  -        Shouldnt be a problem for early adopters.
  --%>
...
%>
        <div class="margin-btm-10px"><fmt:message key="jsp.submit.upload-file-list.info2"/></div>
...
%>
            <tr>
<%-- Remove primary bitstream radio button
