...
<% } %>
    <form id="uploadForm" <%= bSherpa?"class=\"sherpa col-md-8\"":"" %> method="post" 
		...
		<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.index\") + \"#upload\"%>"><fmt:message key="jsp.submit.edit-metadata.help"/></dspace:popup></h1>--%>
...
%>
            <h1>
            <fmt:message key="ub.jsp.submit.choose-file.heading-doctor"/>
	    <dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"ub.help.doctor-path\") + \"#upload\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	    </h1>
	    <fmt:message key="ub.jsp.submit.choose-file.info1-doctor"/>
<%
	}
	else
	{
%>
	    ...
	    <dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"ub.help.master-path\") + \"#upload\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
	    </h1>
...
<%    
    ...
    {
%>
	<fmt:message key="ub.jsp.submit.choose-file.info9-doctor"/>
<%
    }
    else
    {
...
%>
		...
		<p>
		  <fmt:message key="ub.jsp.submit.choose-file.clicknext"/>
		</p>
...
%>
                <p>
		  <fmt:message key="ub.jsp.submit.choose-file.order"/>
		</p>
