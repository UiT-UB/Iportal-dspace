...
<%    
    ...
    {
%>
                <dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"ub.help.doctor-path\") + \"#verify\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
<%
    }
    else
    {
%>
                <dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"ub.help.master-path\") + \"#verify\"%>"><fmt:message key="jsp.morehelp"/></dspace:popup>
<%
    }
%>
        </h1>
