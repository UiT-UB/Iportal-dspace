...
<%
	...
	boolean willRemoveDoctoral = ((Boolean) request.getAttribute("will.remove.doctoral")).booleanValue();
...
<%-- Embed necessary information --%>
		...
		<input type="hidden" name="will_remove_doctoral" value="<%= willRemoveDoctoral %>"/>
