...
<html lang="<%= currentLocale %>">
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
		...
		<%-- KM: Add custom stylesheet --%>
	    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/bootstrap/ub.css" type="text/css" />
<%
...
%>
	...
	<script type='text/javascript' src="<%= request.getContextPath() %>/static/js/jquery/jquery-3.5.0.min.js"></script>
...
<%-- KM: Do not show the container banner content
