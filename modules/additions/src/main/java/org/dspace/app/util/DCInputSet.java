...
public class DCInputSet
{
		    					   ...
		    					   boolean addPublishedBefore)
    {
		...
		//KMS: Changed which fields are influenced by the published_before and multiple_titles fields
...
//    	}
		...
		if (rowName.equals("description.argument") && ! addPublishedBefore  )
		{
	    	return false;
		}
		if (rowName.equals("description.condition") && addPublishedBefore  )
		{
	    	return false;
		}
		if (rowName.equals("description.consent") && addPublishedBefore  )
		{
	    	return false;
		}
		if (rowName.equals("description.consentextended") && addPublishedBefore  )
		{
	    	return false;
		}
		if (rowName.equals("description.unpublished") && addPublishedBefore  )
		{
	    	return false;
		}

		if (rowName.equals("description.explanation") && ! addTitleAlternative )
		{
	    	return false;
		}
		if (rowName.equals("description.embargoyears") && ! addTitleAlternative )
		{
	   		return false;
		}
		//KME
