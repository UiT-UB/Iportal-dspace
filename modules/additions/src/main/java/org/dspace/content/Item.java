...
public class Item extends DSpaceObject
{
    ...
    {
    //KMS: Changed order from metadata_field_id to element and qualifier. This way, the metadata in
    //     the full item record, will be alphabetically sorted by the Dublin Core field names.
        return DatabaseManager.queryTable(ourContext, "MetadataValue",
                "SELECT MetadataValue.* FROM MetadataValue, MetadataFieldRegistry " +
        " WHERE item_id= ? AND MetadataFieldRegistry.metadata_field_id=MetadataValue.metadata_field_id" +
        " ORDER BY element, qualifier, place",
