...
public class Email
{
    ...
    //KMS: Add subject appendix
    /** Subject appendix, for more dynamic subjects */
    private String subjectAppendix;
    //KME
    ...
    //KMS: Set subject appendix
    /**
     * Set the subject appendix
     *
     * @param sa
     *            the subject appendix
     */
    public void setSubjectAppendix(String sa)
    {
	subjectAppendix = sa;
    }
    //KME
	...
	String fullSubject = MessageFormat.format(subject + subjectAppendix, args);
	//KME
        if (charset != null)
        {
